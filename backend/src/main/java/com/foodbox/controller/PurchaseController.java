...
public class PurchaseController {
	//To create the instance of purchaserepo
	
	@Autowired
	private PurchaseRepository purchaseRepository;
	
	//To create the instance of cartrepo
	@Autowired
	private CartRepository cartRepository; 
	//To create the instance of customerrepo
	@Autowired
	private CustomerRepository customerRepository;
	//To retrieve the orders of the customer using customer email
	...
	//To retrieve all the purchases
	@GetMapping("/purchase")
	public List<Purchase> getAllPurchase(){
		return purchaseRepository.findAllByOrderByTransactionidAsc();
	}
	//To delete the purchase using the purchase id
	...
	//To add the details to the purchase entity
